        ...
        <section class="classic">
            ...
            <div class="continuous">
                <div class="box next-hour">
                    ...
                    <div class="status">
                        <h1>Ertesi Gün</h1>
                        <h3>{{ data.list[24 / 3].main.temp }}<span>°C</span></h3>
                        <span>{{ makeDescription(data.list[24 / 3].weather[0].description) }}</span>
                    </div>
                </div>
...
const renew = async () => {
    ...
    console.log(data.value.list[0].weather[0].icon);
    ...
    ContinuousIcon.value!.style.backgroundImage = `url('/weather/${makeIcon(data.value.list[24 / 3].weather[0].icon)}.svg')`;

    if (["01n", "02n", "03n", "04n", "09n", "10n", "11n", "13n", "50n", "11d"].includes(data.value.list[0].weather[0].icon)) {
    ...
    if (["Rainy", "Thunder"].includes(makeIcon(data.value.list[0].weather[0].icon))) {
    ...
    else if (["Snow"].includes(makeIcon(data.value.list[0].weather[0].icon))) {
...
onMounted(async () => {
    if (!CurrentIcon.value || !ContinuousIcon.value) return;
